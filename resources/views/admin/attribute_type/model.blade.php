<div id="attributeModal" x-data="{  form: { attribute_name: '' , attribute_id: '' } }" class="fixed inset-0 hidden items-center justify-center z-50">
    ...
    <div class="bg-white p-8 rounded-2xl shadow-2xl w-[600px] max-w-[90%] relative z-10">
        ...
        <form id="attributeForm" class="space-y-6">
            ...
            <div class="flex items-center gap-3">
                <div class="w-full">
                    <label class="block text-gray-700 font-medium mb-2">Attribute Name<span
                            class="text-red-500">*</span></label>
                    <input type="text" name="attribute_name" id="attribute_name" x-model="form.attribute_name"
