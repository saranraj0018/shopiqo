<footer class="bg-[#111] text-white pt-8 sm:pt-12">
        ...
        <div class="flex flex-wrap lg:flex-nowrap items-start justify-between gap-10">
            ...
            <div class="w-full sm:w-[45%] lg:w-[22%]">
                ...
                <p class="text-sm text-gray-400 leading-relaxed max-w-[220px]">
                    Custom corporate gifts made simple.
    ...
    <!-- BOTTOM BAR -->
    <div class="bg-gray-200 text-black text-sm py-2">
        <div
            class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-2 md:gap-4">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="#" class="hover:underline text-center">Terms of Service</a>
                <a href="#" class="hover:underline text-center">Privacy Policy</a>
            </div>
