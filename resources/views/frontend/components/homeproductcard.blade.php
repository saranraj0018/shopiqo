...
<div class="w-full bg-white rounded-[20px] overflow-hidden border border-black/10 shadow-sm">
    ...
    <div class="p-4 sm:p-5">
        ...
        @endphp
        <div class=" flex items-end justify-between items-center mt-[10px] gap-3">
            <div class="flex flex-wrap gap-3 items-end">
                <div class="flex items-end gap-1">
                    <span class="text-[24px] sm:text-[22px] md:text-[20px] lg:text-[24px] font-semibold text-black leading-none">
                        ₹{{ $salePrice }}
                    </span>
